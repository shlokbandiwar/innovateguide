...
export default function Footer() {
  return (
    <footer className="bg-surface-container-low text-neutral-muted py-12 border-t border-neutral-outline/20 transition-colors">
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8">
        ...
        <div className="flex flex-col gap-4 sm:col-span-2 md:col-span-2">
          <Link to="/" className="flex items-center gap-2" aria-label="InnovateGuide Home">
            ...
            <span className="font-bold text-lg text-neutral-dark">InnovateGuide</span>
          </Link>
        ...
        <div className="flex flex-col gap-3">
          <h3 className="font-bold text-neutral-dark text-sm tracking-wider uppercase">Quick Links</h3>
          <ul className="flex flex-col gap-2 text-sm" aria-label="Quick Links Menu">
        ...
        {/* Column 3: Categories */}
        <div className="flex flex-col gap-3">
          <h3 className="font-bold text-neutral-dark text-sm tracking-wider uppercase">Categories</h3>
          <ul className="flex flex-col gap-2 text-sm" aria-label="Market Categories Menu">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            <h3 className="font-bold text-neutral-dark text-sm tracking-wider uppercase">Contact</h3>
            <ul className="flex flex-col gap-1 text-sm text-neutral-muted">
          ...
          <div className="flex flex-col gap-2">
            <h3 className="font-bold text-neutral-dark text-sm tracking-wider uppercase">Social Media</h3>
            <div className="flex items-center gap-3 text-primary">
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="hover:text-secondary" aria-label="InnovateGuide GitHub">
                <span className="material-symbols-outlined text-lg">code</span>
              </a>
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="hover:text-secondary" aria-label="InnovateGuide Twitter">
                <span className="material-symbols-outlined text-lg">chat</span>
              </a>
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="hover:text-secondary" aria-label="InnovateGuide LinkedIn">
